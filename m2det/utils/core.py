...
from data import COCODetection, VOCDetection, VisDroneDetection, detection_collate, preproc
...
def get_dataloader(cfg, dataset, setname='train_sets'):
    ...
    Dataloader_function = {'VOC': VOCDetection, 'COCO':COCODetection, 'VIS':VisDroneDetection}
    _Dataloader_function = Dataloader_function[dataset]
    
    rootpath = ""
    if dataset == 'COCO' :
        rootpath = cfg.COCOroot
    elif dataset == 'VIS' :
        rootpath = cfg.VISroot
    else :
        rootpath = cfg.COCOroot
